...
function calage(){
 ...
 {
  alert("Please fill all the values and then click submit button || कृपया पहले सभी सूचनाएं भरें, फिर submit बटन पर क्लिक करें -");
 } 
 else
 {
  ...
  document.cir.val.value=dife[0]+" Years (वर्ष), "+dife[1]+" Months (महीना), and "+dife[2]+" Days (दिन)";

  var secleft = diff/1000/60;
  document.cir.val3.value=secleft+" [ Minutes since your Birth || मिनट, आपके जन्म से अब तक ]";

  var hrsleft = secleft/60;
  document.cir.val2.value=hrsleft+" [ Hours since your Birth || घण्टे, आपके जन्म से अब तक ]";
 
  var daysleft = hrsleft/24;
  document.cir.val1.value=daysleft+" [ Days since your Birth || दिन, आपके जन्म से अब तक ]"; 
  ...
  document.cir.val4.value=datee+" [ Days left for your next birthday || दिनों  बाद आपका अगला जन्मदिन आएगा  ]"; 
 }
}
